...
<head>
    ...
    <meta property="og:image" content="{{ $product_seo->image_secure_url ?? $seo->image_secure_url }}">
    <meta property="og:image:secure_url" content="{{ $product_seo->image_secure_url ?? $seo->image_secure_url }}">
    ...
    <meta property="twitter:image" content="{{ $product_seo->image_secure_url ?? $seo->image_secure_url }}">
